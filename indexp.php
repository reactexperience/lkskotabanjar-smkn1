    ...
    <div class="navbar">
       <div class="container">
        <ul>
            ...
            <li style="float: right;"><a href="pembeli/keranjang.php"><ion-icon style="font-size: 32px; color: white;" name="cart"></ion-icon></a></li>
        ...
        <div class="row">
           <?php while($row = mysqli_fetch_assoc($produk)){ ?>
            <div class="column">
                ...
                <a href="pembeli/product-page.php?id=<?= $row['id']; ?>"><button class="btn-gradient">Beli</button></a>
            </div>
            <?php } ?>
<!--
            <div class="column">
