  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin.php">
        ...
        <div class="sidebar-brand-text mx-3">REACT-SHOP</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Ini Produkku</h6>
            <a class="collapse-item" href="produk.php">Daftar Produk</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="pelanggan_konfirmasi.php">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Konfirmasi Pelanggan</span></a>
      </li>
